...
TOPICS: dict[str, list[str]] = {
    ...
    "graphic-ai": [
        "AI design tools overview — what they help and what they don’t",
        "Prompt craft for still images — clear subject, style, composition",
        "Iteration — refining prompts, variations, selecting winners",
        "Composition rules — rule of thirds, contrast, whitespace",
        "Typography over AI art — readable hierarchy on generated images",
        "Social media pack — square/story formats and safe zones",
        "Brand consistency — palettes, reuse of motifs, style references",
        "Ethics & rights — AI images, attribution, school-safe content",
        "Mockups — present designs on phone/poster mock surfaces",
        "Hybrid workflow — AI base + manual polish in a design app",
        "Campaign set — 3 coordinated assets for one message",
        "Capstone — full mini brand kit with AI-assisted artwork",
    ],
    "video-editing-ai": [
        "Video editor interface — timeline, clips, project settings",
        "Import & organise media — bins, naming, simple cuts",
        "Cutting for story — jump cuts, B-roll, pacing",
        "Audio basics — levels, mute, simple background music",
        "Titles & lower-thirds — readable on-screen text",
        "Transitions — when to use (and when not to)",
        "Colour basics — exposure, contrast, simple correction",
        "AI assist tools — auto captions / cleanup / generative helps",
        "Short-form export — vertical 9:16 for reels/shorts",
        "Story structure — hook, body, call-to-action",
        "Motion & simple animation — keyframes intro",
        "Sound design — voice clarity and ambient balance",
        "Interview / talking-head cutdowns",
        "Product demo style edit",
        "Revision — feedback rounds and version naming",
        "Capstone — 60–90 second polished promo or tutorial",
    ],
    "ai-engineer": [
